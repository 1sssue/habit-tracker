...
const PageWrapper = styled.div`
  ...
  position: relative; /* Для позиціонування кнопки теми */
`;
...
const ThemeBtn = styled.button`
  ...
  &:hover { transform: translateY(-2px); border-color: #6a11cb; }
`;
...
const Input = styled.input`
  ...
  font-size: 1.1rem;
  transition: all 0.2s ease;
  &:focus { border-color: #6a11cb; box-shadow: 0 0 0 3px rgba(106, 17, 203, 0.2); }
...
const LinkText = styled.p`
  color: ${(props) => props.theme.textSec}; text-align: center; margin-top: 25px;
